    ...
    render()
    {
        ...
        const header =
            <>
                ...
                <Button icon="pi pi-print" style={{ float: 'right' }} tooltip="Save & Print" tooltipOptions={{ position: 'bottom' }} onClick={this.saveAppointment} />
            </>
        return (
            <>
                <div className="row">
                                ...
                                <div className="row">
                                    <div className="col-md-3">
                                        <div className="form-group">
                                            <button className="btn btn-sm btn-secondary" type="button" onClick={(e) => this.handleValidation() && this.setState({ dialogVisible: true })}> <i className="fa fa-plus"></i> Add Medicine</button>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">

...
export default class Ipds extends Component {
  ...
  render() {
    const { ipds, totalRecords, rows, first, loading, multiSortMeta, filters, deleteDialog, selectedIpd, isArchive, selectedAddmissionDate, selectedDischargeDate, selectedIpdType, editDialog, includeProperties, invoiceDialog } = this.state;

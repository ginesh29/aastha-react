...
export default class Ipds extends Component {
	constructor(props) {
		...
		this.state = {
			...
			loading: true,
			controller: "ipds",
			includeProperties: "Patient.Address,Charges.ChargeDetail,DeliveryDetail,OperationDetail,IpdLookups.Lookup",
			selectedIpd: null,
	...
	render() {
		...
		return (
			<>
				...
				<Dialog header="Ipd Invoice" visible={invoiceDialog} onHide={() => this.setState({ invoiceDialog: false })} className="p-scroll-dialog" style={{ width: "650px" }} dismissableMask={true}>
					{invoiceDialog && (

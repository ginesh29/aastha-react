...
export default class Ipds extends Component
{
    constructor(props)
    {
        ...
        this.state = {
            ...
            loading: true,
            controller: "ipds",
            includeProperties: "Patient,Charges,DeliveryDetail,OperationDetail,IpdLookups.Lookup",
            selectedIpd: null,
    ...
    render()
    {
        ...
        return (
            <>
                ...
                <Dialog header="Edit pd" visible={editDialog} onHide={() => this.setState({ editDialog: false })}>
                    {
                        editDialog &&

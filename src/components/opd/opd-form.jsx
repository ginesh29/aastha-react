...
export default class OpdForm extends React.Component {
	...
	handleSubmit = (e) => {
		...
		if (this.handleValidation()) {
			...
			this.repository.post(`${controller}?includeProperties=${includeProperties ? includeProperties : ""}`, opd).then((res) => {
				if (res && !res.errors) {
		...
		return (
			<>
				<form onSubmit={this.handleSubmit} onReset={this.handleReset}>
					...
					<div className="row">
						<div className="col">
							<InputField name="consultCharge" title="Consulting Charges" value={consultCharge || defaultCharge} onChange={this.handleChange} {...this.state} controlType="input-group-addon" groupIcon="fa-inr" keyfilter="pint" />
						</div>
						<div className="col">
							<InputField name="usgCharge" title="USG Charges" value={usgCharge || defaultCharge} onChange={this.handleChange} {...this.state} controlType="input-group-addon" groupIcon="fa-inr" keyfilter="pint" />
						</div>
						<div className="col">
							<InputField name="uptCharge" title="UPT Charges" value={uptCharge || defaultCharge} onChange={this.handleChange} {...this.state} controlType="input-group-addon" groupIcon="fa-inr" keyfilter="pint" />
						</div>
					</div>
					<div className="row">
						<div className="col">
							<InputField name="injectionCharge" title="Injection Charges" value={injectionCharge || defaultCharge} onChange={this.handleChange} {...this.state} controlType="input-group-addon" groupIcon="fa-inr" keyfilter="pint" />
						</div>
						<div className="col">
							<InputField name="otherCharge" title="Other Charges" value={otherCharge || defaultCharge} onChange={this.handleChange} {...this.state} controlType="input-group-addon" groupIcon="fa-inr" keyfilter="pint" />
						</div>
						<div className="col">
							<InputField name="totalCharge" title="Total Charges" value={totalCharge || defaultCharge} onChange={this.handleChange} {...this.state} controlType="input-group-addon" groupIcon="fa-inr" readOnly="readOnly" className="p-readonly" />
						</div>
					</div>

			...
			<>
				<div className="card">
					<div className="card-body">
						<ReportFilter {...this.state} onDateSelection={this.onDateSelection} onReportTypeChange={(e) => this.setState({ reportType: e.value })} onShowSummary={(e) => this.op.toggle(e)} data={ipdData} exportReport={this.exportReport} activeIndex={activeIndex} />
						<hr />
						<TabView activeIndex={this.state.activeIndex} onTabChange={(e) => this.setState({ activeIndex: e.index })}>
							...
							<TabPanel header="Summary">
								<div ref={(el) => (this.printSummaryRef = el)} id="print-div">
									<h3 className="report-header">Ipd Report Summary{reportTitle}</h3>
									<table className="table table-bordered report-table table-sm">
										<thead>
											<tr>
												<th>Date</th>

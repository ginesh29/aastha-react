                    ...
                    <div className="col-md-7">
                        <div className="p-inputgroup pull-right">
                            <div className="form-group">
                                ...
                                <Calendar name="dateSelection" value={dateSelection} onChange={onDateSelection} readOnlyInput={true} style={{ display: reportType === reportTypeEnum.DAILY.value ? "" : "none" }} dateFormat="d/m/yy" monthNavigator={true} yearNavigator={true} yearRange={TEN_YEAR_RANGE} />
                                <Calendar name="dateRangeSelection" value={dateRangeSelection} onChange={onDateSelection} selectionMode="range" readonlyInput={true} readOnlyInput={true} style={{ display: reportType === reportTypeEnum.DATERANGE.value ? "" : "none" }} dateFormat="d/m/yy" monthNavigator={true} yearNavigator={true} yearRange={TEN_YEAR_RANGE} />

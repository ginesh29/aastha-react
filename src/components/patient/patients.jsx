...
export default class Patients extends Component {
	...
	deleteRow = () => {
		...
		this.repository.delete(controller, `${selectedPatient.id}?isDeleted=${!isArchive}`).then((res) => {
			this.setState({
	...
	render() {
		let { patients, totalRecords, rows, first, loading, multiSortMeta, filters, deleteDialog, editDialog, isArchive, selectedPatient, includeProperties, selectedAddress, addressOptions, startNo, endNo } = this.state;

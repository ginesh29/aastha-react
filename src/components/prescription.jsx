    ...
    const header = (
      <>
        ...
        <div className="float-right">
          <ReactToPrint trigger={() => <Button icon="pi pi-print" tooltip="Save & Print" tooltipOptions={{ position: "bottom" }} />} content={() => this.printRef} onAfterPrint={this.saveAppointment} />
        </div>
      </>
    );
